...
- Active project work: Qari · **Safar** kickoff (PoC requirements + design system approved 2026-09-24; Claude Design prototype next — `pocs/safar/project-os/`).
  Per-project state in [STATUS.md](STATUS.md).
